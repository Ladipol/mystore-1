...
npx shadcn@2.1.3 add button --force
```
...
npx shadcn@2.1.3 add breadcrumb card checkbox dropdown-menu input label popover select separator table textarea toast skeleton carousel
```
